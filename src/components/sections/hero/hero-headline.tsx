...
export function HeroHeadline() {
  ...
  return (
    <div className="flex max-w-3xl flex-col gap-5 sm:gap-8 lg:gap-10">
      <motion.p
        variants={labelReveal}
        initial="hidden"
        animate="visible"
        custom={0.75}
        className="text-caption text-gold-300/80 rtl:tracking-normal max-w-full uppercase tracking-[0.22em] sm:tracking-[0.32em]"
      >
        {t("eyebrow")}
      </motion.p>
      ...
      <h1
        ...
        className="font-body max-w-[16.75rem] xs:max-w-none -ms-[0.02em] font-light leading-[1.04] tracking-[-0.035em] text-neutral-50 text-[clamp(1.75rem,5vw+0.85rem,2.5rem)] sm:text-display-xl lg:text-[clamp(3.5rem,7.2vw,6.25rem)] sm:leading-[0.98] sm:tracking-[-0.04em]"
      >
        <span className="inline-flex flex-wrap items-baseline gap-x-[0.14em] gap-y-1 sm:gap-x-[0.18em] sm:gap-y-2">
          ...
          <WordReveal
            ...
            wordClassName="font-heading text-gold-200/95 rtl:not-italic relative -top-[0.02em] sm:-top-[0.03em] font-medium italic tracking-[-0.025em]"
          />
        </span>
      </h1>
      ...
      <motion.p
        ...
        className="text-body-md text-neutral-200/75 max-w-[30ch] leading-[1.7] tracking-[0.015em] sm:text-body-lg sm:max-w-[34ch] sm:leading-[1.75] lg:text-body-xl lg:max-w-[38ch]"
      >
        {t("subheadline")}
      </motion.p>
    </div>
